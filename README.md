...
- `ASSIGNMENT START <Assignment_name>` — begins the Canvas assignment description in markdown (`CRT_HW START` also accepted)
- `ASSIGNMENT END` — ends the assignment description (`CRT_HW END` also accepted)
